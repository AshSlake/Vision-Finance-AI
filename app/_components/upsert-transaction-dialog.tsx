...
interface UpersertTransactionsDialogProps {
  isOpen: boolean;
...
const formSchema = z.object({
  ...
  amount: z.number({ required_error: "O nome é obrigatorio" }).positive({
    message: "O valor é obrigatorio e precisa ser um número positivo.",
  }),
...
const UpsertTransactionDialog = ({
  ...
  transactionId,
  setIsOpen,
}: UpersertTransactionsDialogProps) => {
